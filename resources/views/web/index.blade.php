            ...
            <div class="courses-slider style-2 owl-carousel owl-theme">
               ...
               <div class="single-courses-card style3">
                  <div class="courses-img">
                     <a href="{{ route('web.school-of-medicine', ['id'=>$v->slug]) }}"><img src="{{ url('uploads/school-of-medicine-course/'.$v->image) }}" alt="Image"></a>
                  </div>
      ...
      <div class="lates-news-area ptb-50 bg-f4f6f9">
         <div class="container">
            ...
            <div class="news-slider owl-carousel owl-theme">
               ...
               <div class="single-news-card style2">
                  <div class="news-img">
                     <a href="{{ url('uploads/success-story/'.$v->image) }}"><img src="{{ url('uploads/success-story/'.$v->image) }}" alt="Image"></a>
                  </div>
                  <div class="news-content">
