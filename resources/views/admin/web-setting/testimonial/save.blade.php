...
@section('content')
	...
	<div class="card">
	    <div class="card-header border bottom">
	        ...
	        <a href="{{ route('web-setting.testimonial') }}" class="btn btn-gradient-success" style="float: right;">Back</a>
	    </div>
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">

	            	<form action="{{ route('web-setting.store-testimonial') }}" method="POST" class="m-t-15" id="form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $edit_data && $edit_data->link ? $edit_data->link : ''  }}" name="link" placeholder="Enter Banner Link" required>
                                </div>
                            </div>
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.testimonial') }}';
		                    }, 1500);
		                }else{
