...
@section('content')
	...
	<div class="card">
	    <div class="card-header border bottom">
	        ...
	        <a href="{{ route('web-setting.latest-news') }}" class="btn btn-gradient-success" style="float: right;">Back</a>
	    </div>
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	
	            	<form action="{{ route('web-setting.store-latest-news') }}" method="POST" class="m-t-15" id="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $edit_data && $edit_data->title ? $edit_data->title : ''  }}" class="form-control" name="title" placeholder="Enter Announcement Title" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Link <span class="text-danger">*</span></label>
                                    <input type="url" class="form-control" value="{{ $edit_data && $edit_data->link ? $edit_data->link : ''  }}" name="link" placeholder="Enter Banner Link" required>
                                </div>
                            </div>
			                ...
			                <div class="col-md-6">
                                <div class="form-group">
                                	...
                                	<img src="{{ $edit_data && $edit_data->image ? url('uploads/latest-news/'.$edit_data->image) : ''  }}" class="img img-fluid" style="width: 25%;">
                                	@endif
                                </div>
                            </div>
                            <div class="col-md-6">
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.latest-news') }}';
		                    }, 1500);
		                }else{
