    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-right">
                <a href="{{ route('web-setting.save-school-and-program') }}" class="btn btn-gradient-success">Add School And Program</a>
            </div>
            @endcan
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.datatable').DataTable({
                ...
                ajax: "{{ route('web-setting.list-school-and-program') }}",
                columns: [
                     { data: 'id' },
                     { data: 'title' },
                     { data: 'image' },
