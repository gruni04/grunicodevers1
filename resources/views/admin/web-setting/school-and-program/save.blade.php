...
@section('content')
	...
	<div class="card">
	    <div class="card-header border bottom">
	        ...
	        <a href="{{ route('web-setting.school-and-program') }}" class="btn btn-gradient-success" style="float: right;">Back</a>
	    </div>
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	
	            	<form action="{{ route('web-setting.store-school-and-program') }}" method="POST" class="m-t-15" id="form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Collage Image <span class="text-danger">*</span></label>
                                	<input id="image" name="image" type="file" class="form-control" {{ $edit_data && $edit_data->image ? '' : 'required'  }}>
                                	@if($edit_data && $edit_data->image)
                                	<img src="{{ $edit_data && $edit_data->image ? url('uploads/school-and-program/'.$edit_data->image) : ''  }}" class="img img-fluid" style="width: 25%;">
                                	@endif
                                </div>
                            </div>
                            <div class="col-md-12">
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.school-and-program') }}';
		                    }, 1500);
		                }else{
