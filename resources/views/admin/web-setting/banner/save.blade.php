	    ...
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	...
	            	<form action="{{ route('web-setting.store-banner') }}" method="POST" class="m-t-15" id="form">
	            		<input type="hidden" name="edit_id" value="{{ $edit_data && $edit_data->id ? $edit_data->id : ''  }}" >
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Title <span class="text-danger">*</span></label>
                                    <input type="text" value="{{ $edit_data && $edit_data->title ? $edit_data->title : ''  }}" class="form-control" name="title" placeholder="Enter Banner Title" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                	...
                                	<img src="{{ $edit_data && $edit_data->image ? url('uploads/home_banner/'.$edit_data->image) : ''  }}" class="img img-fluid" style="width: 25%;">
                                	@endif
                                </div>
                            </div>
                            <div class="col-md-12">
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.banner') }}';
		                    }, 1500);
		                }else{
