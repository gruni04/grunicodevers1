...
@section('content')
	...
	<div class="card">
	    <div class="card-header border bottom">
	        ...
	        <a href="{{ route('web-setting.school-of-medicine-course') }}" class="btn btn-gradient-success" style="float: right;">Back</a>
	    </div>
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	
	            	<form action="{{ route('web-setting.store-school-of-medicine-course') }}" method="POST" class="m-t-15" id="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $edit_data && $edit_data->course_name ? $edit_data->course_name : ''  }}" class="form-control" name="course_name" placeholder="Enter School of Medicine Course Name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                	...
                                	<img src="{{ $edit_data && $edit_data->image ? url('uploads/school-of-medicine-course/'.$edit_data->image) : ''  }}" class="img img-fluid" style="width: 25%;">
                                	@endif
                                </div>
                            </div>
                            <div class="col-md-6">
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.school-of-medicine-course') }}';
		                    }, 1500);
		                }else{
