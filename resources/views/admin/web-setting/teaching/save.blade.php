...
@section('content')
	...
	<div class="card">
	    <div class="card-header border bottom">
	        ...
	        <a href="{{ route('web-setting.teaching') }}" class="btn btn-gradient-success" style="float: right;">Back</a>
	    </div>
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	
	            	<form action="{{ route('web-setting.store-teaching') }}" method="POST" class="m-t-15" id="form">
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.teaching') }}';
		                    }, 1500);
		                }else{
