...
@section('content')
	...
	<div class="card">
	    <div class="card-header border bottom">
	        ...
	        <a href="{{ route('web-setting.our-podcast') }}" class="btn btn-gradient-success" style="float: right;">Back</a>
	    </div>
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	...
	            	<form action="{{ route('web-setting.store-our-podcast') }}" method="POST" class="m-t-15" id="form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Episode No <span class="text-danger">*</span></label>
