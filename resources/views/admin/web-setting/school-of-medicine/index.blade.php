    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-right">
                <a href="{{ route('web-setting.save-school-of-medicine') }}" class="btn btn-gradient-success">Add School of Medicine</a>
            </div>
            @endcan
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.datatable').DataTable({
                ...
                ajax: "{{ route('web-setting.list-school-of-medicine') }}",
                columns: [
                     { data: 'id' },
                     { data: 'course' },
                     { data: 'title' },
