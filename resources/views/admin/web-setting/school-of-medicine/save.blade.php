...
@section('content')
	...
	<div class="card">
	    <div class="card-header border bottom">
	        ...
	        <a href="{{ route('web-setting.school-of-medicine') }}" class="btn btn-gradient-success" style="float: right;">Back</a>
	    </div>
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	
	            	<form action="{{ route('web-setting.store-school-of-medicine') }}" method="POST" class="m-t-15" id="form">
                        ...
                        <div class="form-row">
                        	<div class="col-md-6">
                                <div class="form-group">
                                	...
                                	<select name="course" class="form-control" required>
                                        ...
                                        <option value="{{ $v->slug }}" {{ !empty($edit_data) && $v->slug==$edit_data->course ? "selected":''}} >{{ $v->course_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                	...
                                	<img src="{{ $edit_data && $edit_data->image ? url('uploads/school-of-medicine/'.$edit_data->image) : ''  }}" class="img img-fluid" style="width: 25%;">
                                	@endif
                                </div>
                            </div>
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.school-of-medicine') }}';
		                    }, 1500);
		                }else{
