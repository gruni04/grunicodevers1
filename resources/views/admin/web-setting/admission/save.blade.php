	    ...
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	...
	            	<form action="{{ route('web-setting.store-admission') }}" method="POST" class="m-t-15" id="form">
                        ...
                        <div class="form-row">
                        	<div class="col-md-6">
                                <div class="form-group">
                                	...
                                	<select name="category" class="form-control" required>
                                        ...
                                        @foreach($admission_category as $k=>$v)
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                	...
                                	<img src="{{ $edit_data && $edit_data->image ? url('uploads/admission/'.$edit_data->image) : ''  }}" class="img img-fluid" style="width: 25%;">
                                	@endif
                                </div>
                            </div> --}}
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.admission') }}';
		                    }, 1500);
		                }else{
