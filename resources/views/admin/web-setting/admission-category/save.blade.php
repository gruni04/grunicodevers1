...
@section('content')
	...
	<div class="card">
	    <div class="card-header border bottom">
	        ...
	        <a href="{{ route('web-setting.admission-category') }}" class="btn btn-gradient-success" style="float: right;">Back</a>
	    </div>
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	
	            	<form action="{{ route('web-setting.store-admission-category') }}" method="POST" class="m-t-15" id="form">

	            		<input type="hidden" name="edit_id" value="{{ $edit_data && $edit_data->id ? $edit_data->id : ''  }}" >
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Admission Category <span class="text-danger">*</span></label>
                                    <input type="text" value="{{ $edit_data && $edit_data->category ? $edit_data->category : ''  }}" class="form-control" name="category" placeholder="Enter Admission Category" required>
                                </div>
                            </div>
                            <div class="col-md-6">
		              ...
		              success:function(responce)
		              {
		                 if(responce.status==1)
		                {
		                    ...
		                    window.setTimeout(function() {
		                    	window.location.href = '{{ route('web-setting.admission-category') }}';
		                    }, 1500);
		                }else{
