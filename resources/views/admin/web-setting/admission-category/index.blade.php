    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-right">
                <a href="{{ route('web-setting.save-admission-category') }}" class="btn btn-gradient-success">Add Admission Category</a>
            </div>
            @endcan
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.datatable').DataTable({
                ...
                ajax: "{{ route('web-setting.list-admission-category') }}",
                columns: [
                     { data: 'id' },
                     { data: 'category' },
                     { data: 'is_active' },
