    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-right">
                <a href="{{ route('web-setting.save-university-cateogry') }}" class="btn btn-gradient-success">Add University Category</a>
            </div>
            @endcan
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.datatable').DataTable({
                ...
                ajax: "{{ route('web-setting.list-university-cateogry') }}",
                columns: [
                     { data: 'id' },
                     { data: 'category' },
                     { data: 'is_active' },
