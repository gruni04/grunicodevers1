...
<form action="{{ route('user.save-user-details') }}" method="POST" class="m-t-15" id="form" enctype="multipart/form-data" >
               ...
               <div class="form-row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="employe_id" placeholder="Enter Employee ID"  value="{{ !empty($user_details) && $user_details->employe_id ? $user_details->employe_id : '' }}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Department</label>
                        <input type="text" class="form-control" name="department" placeholder="Enter Department"  value="{{ !empty($user_details) && $user_details->department ? $user_details->department : '' }}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Designation</label>
                        <input type="text" class="form-control" name="designation" placeholder="Enter Designation Name"  value="{{ !empty($user_details) && $user_details->designation ? $user_details->designation : '' }}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Credit Leaves</label>
                        <input type="text" class="form-control" name="credit_leaves" placeholder="Enter Credit Leaves"  value="{{ !empty($user_details) && $user_details->credit_leaves ? $user_details->credit_leaves : '' }}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Date of Joining</label>
                        <input type="text" class="form-control" name="doj" placeholder="Enter Date of Joining"  value="{{ !empty($user_details) && $user_details->doj ? $user_details->doj : '' }}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Basic Salary (₹)</label>
                        <input type="text" class="form-control" name="basic_salary" placeholder="Enter Basic Salary (₹)" required value="{{ !empty($user_details) && $user_details->basic_salary ? $user_details->basic_salary : '' }}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Hourly Rate (₹)</label>
                        <input type="text" class="form-control" name="hourly_salary" placeholder="Enter Hourly Rate (₹)"  value="{{ !empty($user_details) && $user_details->hourly_salary ? $user_details->hourly_salary : '' }}">
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="form-row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="high_school" >
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">12th</label>
                        <input type="file" class="form-control" name="intermediate" >
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Graduation</label>
                        <input type="file" class="form-control" name="graduation" >
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Post Graduation</label>
                        <input type="file" class="form-control" name="post_graduation" >
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="control-label">Others</label>
                        <input type="file" class="form-control" name="other_certificates" >
                     </div>
                  </div>
               </div>
            </div>
