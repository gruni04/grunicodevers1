...
@section('content')
	<div class="card">
		<div class="card-header border bottom">
	        ...
	        <a href="{{ route('admin.student.save-student', ['id'=>$edit_data->id]) }}" class="btn btn-gradient-success" style="float: right;">Edit</a>
        ...
        <div class="card-body">
            <div class="pill-success">
                ...
                <ul class="nav nav-pills border bottom" role="tablist" style="padding-bottom: 10px;">
                    <li class="nav-item">
                        <a href="#pills-success-application" class="nav-link active show" id="application-tab  {{ $application_letter_tab }}" role="tab" data-toggle="tab" aria-selected="true">APPLICATIONS</a>
                    </li>
                    <li class="nav-item">
                        <a href="#pills-success-admission-letter" id="admission-tab" class="nav-link {{ $admission_letter_tab }}" role="tab" data-toggle="tab" aria-selected="false"> ADMISSION LETTER </a>
                    </li>
                    <li class="nav-item">
                        <a href="#pills-success-tution-fee" class="nav-link {{ $tution_fee_tab }}" id="tution-fee-tab" role="tab" data-toggle="tab" aria-selected="false">TUITION FEE</a>
                    </li>
                    <li class="nav-item">
                        <a href="#pills-success-interview-scheduled" class="nav-link {{ $interview_tab }}" id="interview-tab" role="tab" data-toggle="tab" aria-selected="false">INTERVIEW SCHEDULED</a>
                    </li>
                    <li class="nav-item">
                        <a href="#pills-success-university" class="nav-link {{ $univrsity_tab }}" id="university-tab" role="tab" data-toggle="tab" aria-selected="false">UNIVERSITY</a>
                    </li>
                    <li class="nav-item">
                        <a href="#pills-success-indian-office-work" class="nav-link {{ $indian_office_tab }}" id="indian-office-tab" role="tab" data-toggle="tab" aria-selected="false">INDIAN OFFICE WORK</a>
                    </li>
                    <li class="nav-item">
                        <a href="#pills-success-accommodation-hostel" class="nav-link {{ $hostel_tab }}" id="hostel-tab" role="tab" data-toggle="tab" aria-selected="false">ACCOMMODATION/HOSTEL</a>
                    </li>
                </ul>
                <div class="tab-content">
                        ...
                        <div class="p-h-15 p-v-5">
                            <div class="row">
					            <div class="col-sm-12">
					            	...
					            	@include("admin.student-view.tab-application")
					            </div>
					        </div>
                        </div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade" id="pills-success-admission-letter">
                        <div class="p-h-15 p-v-5">
                        	<div class="row">
					            <div class="col-sm-12">
					            	@include("admin.student-view.tab-admission-letter")
					            </div>
					        </div>
                        </div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade" id="pills-success-tution-fee">
                        <div class="p-h-15 p-v-5">
                            <div class="row">
					            <div class="col-sm-12">
					            	@include("admin.student-view.tab-tution-fee")
					            </div>
					        </div>
                        </div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade" id="pills-success-interview-scheduled">
                        <div class="p-h-15 p-v-5">
                            <div class="row">
					            <div class="col-sm-12">
					            	@include("admin.student-view.tab-interview-scheduled")
					            </div>
					        </div>
                        </div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade" id="pills-success-university">
                        <div class="p-h-15 p-v-5">
                            <div class="row">
					            <div class="col-sm-12">
					            	@include("admin.student-view.tab-university")
					            </div>
					        </div>
                        </div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade" id="pills-success-indian-office-work">
                        <div class="p-h-15 p-v-5">
                            <div class="row">
					            <div class="col-sm-12">
					            	@include("admin.student-view.tab-indian-office")
					            </div>
					        </div>
                        </div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade" id="pills-success-accommodation-hostel">
                        <div class="p-h-15 p-v-5">
                            <div class="row">
					            <div class="col-sm-12">
					            	@include("admin.student-view.tab-accomondation-hostel")
					            </div>
					        </div>
                        </div>
                    </div>
...
@section('page-script')
	...
	<!--@include("admin.student-view.student-js")-->
@endsection